...
napi_value CreateAsyncWork(napi_env env, ExecuteHelper *executeHelper, napi_callback_info info)
{
    ...
    if (executeHelper->sync == 0) {
        ...
        napi_create_async_work(
            env, nullptr, workName, Execute, ExecuteSyncDone, reinterpret_cast<void *>executeHelper,
             &(executeHelper->work));
        ...
        napi_create_async_work(
            env, nullptr, workName, Execute, ExecuteDone, reinterpret_cast<void *>executeHelper,
             &(executeHelper->work));
    }
